...
nativeFn(_rexExport_entryWriteFile,interpreter,args,passThisPtr) {
zip_t * arg0 = (zip_t *)((args[0].isRef() ? args[0].getRef() : args[0]).basicValue.unknown);
cStr arg1 = (cStr)(rex::wstring2string((args[1].isRef() ? args[1].getRef() : args[1]).getStr()));
auto rexCallResult = zip_entry_fwrite(arg0,arg1);
return (value){(vint)(rexCallResult)};
}
...
mod->members[L"entryWriteFile"] = managePtr(value{(value::nativeFuncPtr) _rexExport_entryWriteFile});
